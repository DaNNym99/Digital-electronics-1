...
------------------------------------------------------------------------
entity tlc_improved is
    port(
        clk     : in  std_logic;
        reset   : in  std_logic;
        trafic_south : in  std_logic;
        trafic_west : in  std_logic;
        -- Traffic lights (RGB LEDs) for two directions
        south_o : out std_logic_vector(3 - 1 downto 0);
        west_o  : out std_logic_vector(3 - 1 downto 0)
    );
end entity tlc_improved;

------------------------------------------------------------------------
-- Architecture declaration for traffic light controller
------------------------------------------------------------------------
architecture Behavioral of tlc_improved is
    
    
    -- Define the states
    type   t_state is (STOP1, TRAF1, WEST_GO,  WEST_WAIT,
                       STOP2,TRAF2 , SOUTH_GO, SOUTH_WAIT);
