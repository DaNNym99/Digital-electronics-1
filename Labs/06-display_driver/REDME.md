...
### 1.1. Garf
![Timing Diagram](Images/TimeDiagram.png)
...
```
### 2.2. Súbor tb_driver_7seg_4digits.vhdl
```vhdl
------------------------------------------------------------------------
--
...
![Symulation](Images/Symulation.png)
 
### 2.4. Architectura súboru top
```vhdl
